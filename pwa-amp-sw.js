...
const BASE_CACHE_FILES = [
    'http://localhost/wp1/wp-content/plugins/pwa-for-wp/images/logo.png',
'http://localhost/wp1/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',

];

const OFFLINE_CACHE_FILES = [
     'http://localhost/wp1/?amp=1',
];
...
const OFFLINE_PAGE = 'http://localhost/wp1/?amp=1';
const NOT_FOUND_PAGE = 'http://localhost/wp1/?amp=1';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('http://localhost/wp1//wp-admin/');
//    },
];
